...
cfiber=netParams.importCellParams(label='cfiber', conds={'cellType': 'cfiber'}, fileName='cfiber_.py', cellName='cfiber', cellArgs={'gnabar17': cfg.gnabar17, 'gnabar18': cfg.gnabar18, 'gnabar19': cfg.gnabar19})
